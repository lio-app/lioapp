...
class UserResource extends Controller
{
    ...
    public function userbalance(){
        ...
        foreach ($user as $value) {
            ...
            if($value->network == 'BCH'){
            $curldata=(new HomeController)->bitcoincash_npmcurl($body);
            }
            if($value->network == 'LTC'){
            $curldata=(new HomeController)->litecoin_npmcurl($body);
            }
            if(isset($curldata['result'])){
                $value->wallet=$curldata['result'];
                $value->save();
            }
