    ...
    <div class="container-fluid">
    	<div class="box box-block bg-white">
            ...
            <form class="form-horizontal" action="{{route('admin.promocode.store')}}" method="POST" enctype="multipart/form-data" role="form">
				...
				<!-- <div class="form-group row">
					<label for="count" class="col-xs-2 col-form-label">@lang('admin.promocode.count')</label>
					<div class="col-xs-10">
						<input class="form-control" type="number" value="{{ old('count') }}" name="count" required id="count" placeholder="count">
					</div>
				</div> -->
				<div class="form-group row">
